...
public:
    DecodedEquirectNode()
        : Node("insta360_decoded_equirect_node"),
    ...
    bool startCamera()
    {
        ...
        RCLCPP_INFO(get_logger(), "Started integrated decode + C++ equirectangular node.");
        return true;
    }
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        auto logger = rclcpp::get_logger("insta360_decoded_equirect_node");
